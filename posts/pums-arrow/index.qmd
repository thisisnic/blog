...
Earlier this year, the [book](https://arrowrbook.com/) that I co-authored with Jonathan Keane and Neal Richardson, Scaling Up with R and Apache Arrow was published by CRC.  It was a joy to write this book, though a lot of hard work, and one of the big choices we need to make was what dataset we were going to use.
...
You can find the full processing code [here](https://github.com/arrowrbook/book/tree/main/pums_dataset).  Huge thanks to Jonathan who did most of the work on prepping the data for the book!
