...
Earlier this year, the book that I co-authored with Jon Keane and Neal Richardson, Scaling Up with R and Apache Arrow was published by CRC.  It was a joy to write this book, though a lot of hard work, and one of the big choices we need to make was what dataset we were going to use.
...
You can find the full processing code [here](https://github.com/arrowrbook/book/tree/main/pums_dataset).
...
- The data for 2000 - 2006 are in the root directory for that year, but other years have subdirectories depending on whether the 1, 3, or 5 year version
...
## Step 3. Repartitioning and more cleaning the data
...
- Arrow gave us the control (schemas, recodes) and the output format (Parquet) to make messy data usable.
- Working with messy survey data in the book was deliberate — it teaches readers real workflows, not toy pipelines.