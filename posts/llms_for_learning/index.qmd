...
I'm currently collaborating with Charlotte Hadley on an R package called [daisyuiwidget](https://github.com/thisisnic/daisyuiwidget/), which is a [htmlwidgets](https://www.htmlwidgets.org/) package.
...
One example of a htmlwidgets package is [DT](https://rstudio.github.io/DT/), which can be used to create interactive tables. You can see an example below.
...
The goal with daisyuiwidget is to create a new htmlwidgets package, using LLMs - we'll be talking more about this in our joint presentation at [Shiny in Production](https://shiny-in-production.jumpingrivers.com/) later on this year.
...
I'm going to be talking at [Posit Conf](https://posit.co/conference/) about increasing productivity with LLMs and a central thesis of my talk is the idea that LLMs are most useful when working on tasks just outside of your [comfort zone, sometimes described as your stretch zone](https://en.wikipedia.org/wiki/Comfort_zone).
