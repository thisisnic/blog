...
Recurse Center is a business, and makes its money from recruitment - RC works with partner companies looking for software engineers and similar roles, though admission to RC isn't predicated on looking for employment via them.
...
* developed my Quarto markdown parser further
...
* submitted and got accepted to give a talk to posit::conf
* passed over being arrow maintainer to the fantastic Jon Keane
...
* to listen to my gut. I have had a frustration for years with public speaking where I know I'm not terrible at it, want to be better, but asking friends and colleagues for feedback often led to (lovely, kind!) validation but not the actionable feedback I wanted. Working with a tutor has been amazing for helping me identify my strengths (I convey passion and excitement for my topic, and especially when I teach, really try to connect with my audience) and weaknesses (my natural speaking speed is about 3 times what it should be, and I could work on structuring information better within a talk)

## Conclusion

I can honestly describe the 3 months I spent at Recurse Center as the best 3 month period of my life. I met some amazing people, and 
